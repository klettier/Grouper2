...
namespace Grouper2.Core
{
    class Parsers
    {
        ...
        public static JObject ParseInf(string infFile, Action<string> debugWrite)
        {
                ...
                for (int b = sectionContent.Offset; b < (sectionContent.Offset + sectionContent.Count); b++)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                debugWrite("Hit duplicate value in inf.");
                    ...
                    if (lineKey == "")
                    {
                        debugWrite("Something has gone wrong parsing an Inf/Ini file.");
                    }
        ...
        public static JObject ParseGppXmlToJson(string xmlFile, Action<string> debugWrite)
        {
