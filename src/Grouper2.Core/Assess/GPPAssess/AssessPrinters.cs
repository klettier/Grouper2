...
namespace Grouper2.Core.GPPAssess
{
    public partial class AssessGpp
    {
        ...
        //static JProperty AssessGppPrinter(
        //    JToken gppPrinter,
        ...
        //    string gppPrinterAction = JUtil.GetActionString(gppPrinterProps["@action"].ToString(), debugWrite);
        ...
        //    JToken gppPrinterPath = investigatePath(JUtil.GetSafeString(gppPrinterProps, "@path"));
        //    JToken gppPrinterComment = investigateString(JUtil.GetSafeString(gppPrinterProps, "@comment"));
        //    JToken gppPrinterLocation = investigateString(JUtil.GetSafeString(gppPrinterProps, "@location"));
