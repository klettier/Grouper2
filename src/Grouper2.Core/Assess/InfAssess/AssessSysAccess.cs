...
namespace Grouper2.Core.InfAssess
{
    ...
    {
        public static JObject AssessSysAccess(JToken sysAccess, int intLevelToShow)
        {

            JObject assessedSysAccess = new JObject();

            if ((intLevelToShow <= 1) && (sysAccess["MinimumPasswordAge"] != null))
            {
            ...
            if ((intLevelToShow <= 1) && (sysAccess["MaximumPasswordAge"] != null))
            {
            ...
            if ((intLevelToShow <= 1) && (sysAccess["MinimumPasswordLength"] != null))
            {
            ...
            if ((intLevelToShow <= 1) && (sysAccess["PasswordComplexity"] != null))
            {
            ...
            if ((intLevelToShow <= 1) && (sysAccess["PasswordHistorySize"] != null))
            {
            ...
            if ((intLevelToShow <= 3) && (sysAccess["LockoutBadCount"] != null))
            {
            ...
            if ((intLevelToShow <= 3) && (sysAccess["ResetLockoutCount"] != null))
            {
            ...
            if ((intLevelToShow <= 3) && (sysAccess["LockoutDuration"] != null))
            {
            ...
            if ((intLevelToShow <= 1) && (sysAccess["ForceLogoffWhenHourExpire"] != null))
            {
            ...
            if ((intLevelToShow <= 4) && (sysAccess["NewAdministratorName"] != null))
            {
            ...
            if ((intLevelToShow <= 1) && (sysAccess["NewGuestName"] != null))
            {
            ...
            if ((intLevelToShow <= 7) && (sysAccess["ClearTextPassword"] != null))
            {
            ...
            if ((intLevelToShow <= 3) && (sysAccess["LSAAnonymousNameLookup"] != null))
            {
